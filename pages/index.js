...
export default () => {
  ...
  return (
    <div>
      <div className="p-4 bg-white rounded shadow max-w-md sm:max-w-xl md:max-w-4xl lg:max-w-6xl mx-auto lg:px-12 py-8">
      ...
      <div className="px-0 sm:px-4 max-w-md sm:max-w-xl md:max-w-4xl lg:max-w-6xl mx-auto md:px-8 lg:px-12 py-8">
